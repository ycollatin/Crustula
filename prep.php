...
#
###############################################################################
le premier ablatif porte le n. 104
*/
include "lexica/prepositions.php";
$titre = "PRAEPOSITIONES";
...
// casum dein sententiam sortiri
if (mt_rand(0, 100) < 50)
        $p = $bini[mt_rand(0,103)];
else    $p = $bini[mt_rand(104, count($bini) -1)];

// l : latine ; g : gallice ; u : uerbum.
$l = $p[0]; 
$g = $p[1];
$u = $p[2];
$dataM = $p[3];
...
if ($niveau == 1) {
  echo "<input type=\"submit\" class=\"question\" value=\"accusatif\" name=\"resp\">&nbsp;";
  echo "<input type=\"submit\" class=\"question\" value=\"ablatif\" name=\"resp\">";
} else {
