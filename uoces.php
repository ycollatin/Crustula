...
if (isset($r)) {
    ...
    if ($recte) {
	    echo "<div class=\"juste\">RECTE !</div>"; 
            $cognita = succes("lexica/thema.php", $cognita, $gal); 
    } else {
	    echo " : $s$alin";
	    echo "<div class=\"faux\"> Errauisti. Respondisti $resp </div>$alin"; 
            $cognita = echec("lexica/thema.php", $cognita, $gal);
    }
    $facta = bilan($cognita);
...
$linea = Qincr("lexica/thema.php", $cognita);
$latine = $linea[0];
$gallice = $linea[1];
