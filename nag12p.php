...
$lcasus = array("nominatif", "accusatif", "génitif");
$lnumerus = array("singulier", "pluriel");
...
$casus = sorsColl($lcasus);
$numerus = sorsColl($lnumerus);
$quaestio = "$lemme, $casus $numerus";
...
if (isset($priorQ)){
   ...
   $priorQ = stripslashes("$eclats[0], $eclats[1] $eclats[2]");
   $priorL = $eclats[0];
   // lemmam extrahere :
   ...
   $sol = declin($priorL, $priorK, ($priorN=="pluriel"));
...
?>
<p class="question">
<?php echo "$quaestio ?$alin"; ?>
</p>
<form method="post">
<p class="question">
<input class="question" type="text" name="resp">
<input type="submit" value="Num recte dixi ?">
<input type="hidden" value="<?php echo "$lemme|$casus|$numerus" ?>" name="priorQ">
</p>
</form>
