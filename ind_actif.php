...
$diclat = array(
   ...
   array("uiuo","lego","uiu","uix","uictum","vivre"), 
   array("tango","lego","tang","tetig","tactum","toucher"), 
   array("maneo","moneo","man","mans","mansum","rester"), 
   ...
   array("uenio","audio","uen","uen","uentum","venir"),
   ...
   array("amitto","lego","amitt","amis","amissum","perdre"),
...
<html>
<head>
  <title>CRVSTVLA - O TEMPORA</title>
<?php 
   include "css.inc";
...
// temps
if ($_SESSION['consec'] > 3 and $temporaMea < count($tempora)-1)
{
    $temporaMea++;
    $_SESSION['consec'] = 0;
}
if ($temporaMea == 0) $tempus = 'présent';
else $tempus = $tempora[mt_rand(0, $temporaMea)];
// mode, personne
$modus = 'indicatif';
...
echo "<input type=\"hidden\" name=\"temporaMea\" value=\"$temporaMea\">\n";
?> 
</p>
<p class="conseil">
  Toutes les questions sont à l'indicatif ; 
  traduire le parfait par le passé simple !</p>
</form>
